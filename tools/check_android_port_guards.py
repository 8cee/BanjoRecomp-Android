...
def main() -> int:
    ...
    require("AUTOMATIC SESSION SUMMARY" in diagnostics_logger and "Captured lines:" in diagnostics_logger
            and "Most frequent errors/fatal lines:" in diagnostics_logger
